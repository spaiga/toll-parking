...
/**
 * API tests for ParkingApi
 */
@Ignore
public class ParkingApiTest {

    private final ParkingApi api = new ParkingApi();
     ...
     */
    @Test
    public void addParkingTest() throws ApiException {
        Parking body = null;
        Parking response = api.addParking(body);
     ...
     */
    @Test
    public void deleteParkingTest() throws ApiException {
        Long parkingId = null;
     ...
     */
    @Test
    public void getLotsTest() throws ApiException {
        String status = null;
        String carType = null;
        List<Lot> response = api.getLots(status, carType);
     ...
     */
    @Test
    public void getParkingBillTest() throws ApiException {
        Long parkingId = null;
        Bill response = api.getParkingBill(parkingId);
     ...
     */
    @Test
    public void getParkingByIDTest() throws ApiException {
        Long parkingId = null;
        Parking response = api.getParkingByID(parkingId);
