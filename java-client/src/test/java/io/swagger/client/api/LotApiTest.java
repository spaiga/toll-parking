...
/**
 * API tests for LotApi
 */
@Ignore
public class LotApiTest {

    private final LotApi api = new LotApi();
     ...
     */
    @Test
    public void addLotTest() throws ApiException {
        Lot body = null;
        Lot response = api.addLot(body);
     ...
     */
    @Test
    public void deleteLotTest() throws ApiException {
        Long lotId = null;
        api.deleteLot(lotId);
    ...
    public void getLotByIDTest() throws ApiException {
        Long lotId = null;
        Lot response = api.getLotByID(lotId);
     ...
     */
    @Test
    public void updateLotStatusTest() throws ApiException {
        Lot body = null;
        Lot response = api.updateLotStatus(body);
