...
public class ParkingsApiServiceImpl extends ParkingsApiService {
    @Override
    ...
    @Override
    public Response getParkingBill(Long parkingId, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
    @Override
